...
(function () {
  ...
  if (footer) {
    ...
    footer.innerHTML = '<div class="shell footer-inner"><p>A project by Chris Benjaminsen.</p><p>Code MIT · Research &amp; traces CC BY 4.0 · <a href="/dumps">Open dataset ↗</a></p></div>';
  }

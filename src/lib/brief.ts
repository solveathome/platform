...
export type SessionInfo = { id: string; jobs: number; max: number | null; length?: string; disk?: number; maxHours: number; compute: string; transcriptPreapproved: boolean; subagents?: string; files?: { left: number; bytes_left: number; per_day: number } };
